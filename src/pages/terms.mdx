...
<p>
  By accessing this Website, accessible from https://langsync.app, you are
...
<p>
  ...
  LangSync's Website for personal, non-commercial transitory viewing only. This
...
<ul>
  ...
  <li>
    attempt to reverse engineer any software contained on LangSync's Website;
  </li>
  <li>
...
<p>
  This will let LangSync to terminate upon violations of any of these
...
<p>
  All the materials on LangSync's Website are provided "as is". LangSync makes
  no warranties, may it be expressed or implied, therefore negates all other
  warranties. Furthermore, LangSync does not make any representations concerning
...
<p>
  LangSync or its suppliers will not be hold accountable for any damages that
  will arise with the use or inability to use the materials on LangSync's
  Website, even if LangSync or an authorize representative of this Website has
...
<p>
  The materials appearing on LangSync's Website may include technical,
  typographical, or photographic errors. LangSync will not promise that any of
  the materials in this Website are accurate, complete, or current. LangSync may
  change the materials contained on its Website at any time without notice.
  LangSync does not make any commitment to update the materials.
</p>

<h2>6. Links</h2>

<p>
  LangSync has not reviewed all of the sites linked to its Website and is not
  responsible for the contents of any such linked site. The presence of any link
  does not imply endorsement by LangSync of the site. The use of any linked
...
<p>
  LangSync may revise these Terms of Use for its Website at any time without
...
<p>
  Any claim related to LangSync's Website shall be governed by the laws of ma
