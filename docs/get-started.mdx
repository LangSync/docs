...
<img
  src="https://docs.langsync.app/img/brand/colored_bg.png"
  style={{
    borderRadius: "25%",
    width: "125px",
    height: "125px",
...
- **Accurate & precise**: Having the most accuracy possible is what matters to LangSync, And thanks to the powerful pre-trained AI models we use, the generated language-specific localization texts will match the sens of the original ones, instead of the direct common translation services out there.
...
- **Easy to use**: LangSync is a CLI tool that is made by a developer for other developers & buisnesses. it exposes direct commands achieve what you want, And the very beginner developer can literally follow our guides & documentation to use it.

- **For Everyone**: LangSync is for everyone. if you have or can provide only one JSON file of one laungage translations, then you can generate 10 more easily, if you are not familiar with CLIs and terminal... don"t worry, LangSync will come as a GUI software app soon.
