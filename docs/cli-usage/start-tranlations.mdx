...
After you setup everything from [authenticating to LangSync](./auth.md) and [configuring](./configure.md) it for your own project with a `langsync.yaml` file, all what is left is the actual magic to happen, right?
