...
After you setup everything for your own project, all what is left is the actual magic to happen, right?

if you prefer seeing an example video of this process in a real project, you can watch this video:
...
Open your terminal, CMD or PowerShell.. under your project filter
path, then run:
...
Sometimes, and especially at this starting stage of <a href="https://langsync.app" target="_blank">LangSync</a>, unexpected errors may happen due to any kind of reason while localizing & translating to a specific language, <a href="https://langsync.app" target="_blank">LangSync</a> will create special kind of JSON files (\*.error.json) that includes details of the error, as example if the error occurs while localizing & translation to the de language, a `de.error.json` will be created containing details:
